...
def TakeImages():
    ...
    # ✅ Append new student details instead of overwriting
...
def TrackImages():
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            Id = str(Id)  # Convert detected ID to string
            ...
            cv2.putText(im, f"{Id}-{name}", (x, y+h), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 2)
